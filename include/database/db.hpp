...
inline constexpr std::string_view NULL_SENTINEL = "sqleditor__null";
...
inline constexpr std::string_view BOOL_TRUE_SENTINEL = "sqleditor__bool_true";
inline constexpr std::string_view BOOL_FALSE_SENTINEL = "sqleditor__bool_false";
