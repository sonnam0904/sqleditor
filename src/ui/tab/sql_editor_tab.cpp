...
namespace {
    ...
    using CompletionItem = sqleditor::TextEditor::CompletionItem;
    using CompletionKind = sqleditor::TextEditor::CompletionKind;
    ...
    detectSqlCompletionContext(const sqleditor::TextEditor::CompletionRequest& request) {
    ...
    std::set<std::string>
    extractReferencedTables(const sqleditor::TextEditor::CompletionRequest& request) {
    ...
    SqlAliasInfo extractAliasInfo(const sqleditor::TextEditor::CompletionRequest& request) {
        SqlAliasInfo info;
    ...
    filterSqlCompletions(const sqleditor::TextEditor::CompletionRequest& request,
...
void SQLEditorTab::formatSQL() {
    std::string formatted = sqleditor::TextEditor::FormatSQL(sqlEditor.GetText());
    if (!formatted.empty()) {
...
void SQLEditorTab::updateCompletionKeywords() {
    ...
    for (const auto& kw : sqleditor::TextEditor::GetDefaultCompletionKeywords()) {
