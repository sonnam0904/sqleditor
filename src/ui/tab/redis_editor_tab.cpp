...
namespace {
    ...
    std::vector<sqleditor::TextEditor::CompletionItem>
    filterRedisCompletions(const sqleditor::TextEditor::CompletionRequest& request,
                           const std::vector<sqleditor::TextEditor::CompletionItem>& items) {
...
RedisEditorTab::RedisEditorTab(const std::string& name, RedisDatabase* db)
    ...
    editor_.SetLanguage(sqleditor::TextEditor::Language::Redis);
