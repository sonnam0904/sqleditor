...
struct ConnectionDialogData {
    ...
    // MongoDB URI options (replicaSet, authSource, ...) — synced from URL paste.
...
static void applyParsedUrlToDialog(HWND dialog, ConnectionDialogData* data,
    ...
    if (data) {
        data->mongoOptions = info.mongoOptions;
    }
...
static DatabaseConnectionInfo snapshotFormInfo(HWND dialog, ConnectionDialogData* data) {
    ...
    if (data) {
        info.mongoOptions = data->mongoOptions;
    }
    return info;
}
...
static void connectServerAsync(ConnectionDialogData* data) {
    ...
    const std::string mongoOptions = data->mongoOptions;
    ...
    std::thread([=]() {
        ...
        info.host = host;
        info.port = port;
        info.mongoOptions = mongoOptions;
...
static const char* kConnectionDialogClass = "SQLEditor_ConnectionDialog";
static const char* kCreateDbDialogClass = "SQLEditor_CreateDbDialog";
